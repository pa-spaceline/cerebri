...
#include "app/hab/casadi/bezier.h"
...
// mode handlers
void hab_mode_attitude_rate(struct context *ctx);
void hab_mode_attitude(struct context *ctx);
void hab_mode_velocity(struct context *ctx);
void hab_mode_bezier(struct context *ctx);
